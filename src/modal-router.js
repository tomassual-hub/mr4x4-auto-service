...
function renderModal(){
  ...
  else if(m.type==='ai-assistant') return `<div class="modal-overlay" data-action="overlay-close"><div class="modal support-chat-modal" onclick="event.stopPropagation()">${aiAssistantModalHTML()}</div></div>`;
