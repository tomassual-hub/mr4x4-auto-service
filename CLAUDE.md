...
- **Auto-commit and push.** Once a change is made and verified (typecheck +
  ...
  to say "commit dan push". Split unrelated changes into separate commits
  the same way past commits in this repo do. Still don't push if tests are
  failing or verification wasn't done.
